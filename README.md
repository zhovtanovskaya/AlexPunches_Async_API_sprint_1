...
Мы представляли себя админку как конструктор для событий о рассылках
...
оставшихся двоих программистов была от силы неделя. Так что цель была 
...
может его разве что выбросить. Если его время жизни 
истекло. Ну или отложить отправку до наступления нужного времени суток у 
получателя, если нужно.
